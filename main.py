...
from user_operations import save_user_interests, get_user_interests, save_user_survey, get_user_survey
from tour_operations import save_tour_to_db, get_tour_by_id, get_popular_tours
from recommendations import get_recommended_tours, get_fallback_recommendations
import parser
import requests
import os
